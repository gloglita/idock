...
* Profiled by the Valgrind tool suite to ensure memory-leak-free.
* Replaced a switch statement by table lookup to increase indirect branch prediction rate.
...
* Added support for docking ligands generated by igrow.
