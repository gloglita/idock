...
// Choose the appropriate Mersenne Twister engine for random number generation on 32-bit or 64-bit platform.
	...
	int monte_carlo_task(ptr_vector<result>& results, const ligand& lig, const size_t seed, const size_t num_mc_iterations, const array<fl, num_alphas>& alphas, const scoring_function& sf, const box& b, const vector<array3d<fl>>& grid_maps);
}
